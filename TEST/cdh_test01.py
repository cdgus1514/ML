...
print("X_train shape >> ", X_train.shape)   # (300, 32, 32, 3)
print("Y_train shape >> ", Y_train.shape)   # (300, 10)
print("X_test shape : ", X_test.shape)      # (300, 32, 32, 3)
print("Y_test shape : ", Y_test.shape)      # (300, 10)
print("======================================================")
...
print("Y_test300 shape >> ", Y_test300.shape)   # (300, 10)
## 데이터 cut >> 300개씩
# X_train = X_train[:300]
# Y_train = Y_train[:300]
# X_test = X_test[:300]
...
# X_train_reshape = X_train.reshape(300, 3072)
# X_test_reshape = X_test.reshape(300, 3072)

# sc = MinMaxScaler()
# # sc = StandardScaler()
# X_train_reshape = sc.fit_transform(X_train_reshape)
# X_test_reshape = sc.transform(X_test_reshape)
# X_train_reshape = X_train_reshape.reshape(300, 32, 32, 3)
# X_test_reshape = X_test_reshape.reshape(300, 32, 32, 3)
...
model.fit_generator(data_generator.flow(X_train300, Y_train300, batch_size=BATCH_SIZE), steps_per_epoch=300, epochs=200)
print("End...")
...
search.fit_(X_train300, Y_train300)
...
print("최종 정답률 >> ", accuracy_score(Y_test300, Y_pred))
last_score = search.score(Y_test300, Y_test)
...
print("RMSE : ", RMSE(Y_test300, Y_pred))
