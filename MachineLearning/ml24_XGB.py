...
tree = XGBClassifier(n_estimators=2000, max_depth=2, random_state=42, bootstrap=True)    
tree.fit(x_train, y_train)
# tree.fit(x_train, y_train, verbose=True, eval_metric="auc", eval_set=[(x_test, y_test)], early_stopping_rounds=5)
