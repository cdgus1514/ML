...
model.add(Dense(1000, input_shape=(3, ), activation="relu", kernel_regularizer=regularizers.l1(0.01)))  # Lasso regression
...
model.fit(x_train, y_train, epochs=100, batch_size=10, validation_data=(x_val, y_val), callbacks=[early_stopping, tb_hist])
